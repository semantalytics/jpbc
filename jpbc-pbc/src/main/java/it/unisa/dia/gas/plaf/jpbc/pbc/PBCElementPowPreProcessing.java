...
public class PBCElementPowPreProcessing implements ElementPowPreProcessing {
    ...
    public Element pow(BigInteger n) {
        ...
        PBCLibraryProvider.getPbcLibrary().pbc_element_pp_pow(result.value, MPZElementType.fromBigInteger(n), elementPPType);
    ...
    public Element powZn(Element n) {
        PBCElement result = (PBCElement) field.newElement();
        PBCLibraryProvider.getPbcLibrary().pbc_element_pp_pow_zn(result.value, ((PBCElement) n).value, elementPPType);
