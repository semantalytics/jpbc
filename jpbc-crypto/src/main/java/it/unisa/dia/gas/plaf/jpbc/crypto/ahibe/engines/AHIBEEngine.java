package it.unisa.dia.gas.plaf.jpbc.crypto.ahibe.engines;

import it.unisa.dia.gas.jpbc.Element;
import it.unisa.dia.gas.jpbc.Pairing;
import it.unisa.dia.gas.plaf.jpbc.crypto.ahibe.params.AHIBEPublicKeyParameters;
import it.unisa.dia.gas.plaf.jpbc.crypto.ahibe.params.AHIBESEncryptionParameters;
import it.unisa.dia.gas.plaf.jpbc.crypto.ahibe.params.AHIBESecretKeyParameters;
import it.unisa.dia.gas.plaf.jpbc.crypto.ahibe.params.AHIBEUtils;
...
public class AHIBEEngine implements AsymmetricBlockCipher {
    ...
    public byte[] processBlock(byte[] in, int inOff, int inLen) {
        ...
        if (key instanceof AHIBESecretKeyParameters) {
            ...
            Element M = C0.mul(pairing.pairing(sk.getK2(), C2).mul(pairing.pairing(sk.getK1(), C1).invert()).invert());
