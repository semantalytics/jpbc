...
public class HVEIP08AttributesEngine implements AsymmetricBlockCipher {
    ...
    public byte[] processBlock(byte[] in, int inOff, int inLen) {
        ...
        if (key instanceof HVEIP08SearchKeyParameters) {
            ...
            Element C0 = pub.getParameters().getElementPowG().powZn(s);
            ...
            for (int i = 0; i < n; i++) {
                ...
                // Populate elements
                elements.add(pub.getElementPowTAt(i, j).powZn(sMinusSi));  // X_i
                elements.add(pub.getElementPowVAt(i, j).powZn(si));        // W_i
            }
