 ...
 */
public class UHIBELW11Engine implements AsymmetricBlockCipher {
    ...
    public void init(boolean forEncryption, CipherParameters param) {
        ...
        if (forEncryption) {
            ...
            this.pairing = PairingFactory.getPairing(((UHIBELW11EncryptionParameters) key).getPublicKey().getCurveParams());
            this.idsNumber = ((UHIBELW11EncryptionParameters) key).getLength();
        } else {
            ...
            this.pairing = PairingFactory.getPairing(((UHIBELW11SecretKeyParameters) key).getCurveParams());
            this.idsNumber = ((UHIBELW11SecretKeyParameters) key).getLength();
        }
