 ...
 */
public class DefaultParameters implements PairingParameters, Externalizable {
    ...
    public DefaultParameters load(InputStream inputStream) {
    ...
    public DefaultParameters load(String path) {
    ...
    public boolean equals(Object o) {
        ...
        DefaultParameters that = (DefaultParameters) o;
