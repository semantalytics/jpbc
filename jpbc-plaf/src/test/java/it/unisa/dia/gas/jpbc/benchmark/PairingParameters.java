...
public class PairingParameters {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("G2 FixedLengthInBytes = " + pairing.getG2().getFixedLengthInBytes());
        System.out.println("GT FixedLengthInBytes = " + pairing.getGT().getFixedLengthInBytes());
        System.out.println("Zr FixedLengthInBytes = " + pairing.getZr().getFixedLengthInBytes());
